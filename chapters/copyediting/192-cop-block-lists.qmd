...
1. Simple lists: bullet point lists and numbered lists.
...
You can put blocks (paragraphs, quotations, etc.) as list items. To do so, align
the following blocks with a couple of spaces:
