...
As explained in @sec-divs, there are a couple of equivalent
variations for this code.

First, *provided that the Div has no other attribute than 
a single class*, you can omit dot and curly braces:
...
Second, you can make the opening and closing 'fences' as
wide as you want, if you find that this makes your source
code more readible. This doesn't affect the output:
