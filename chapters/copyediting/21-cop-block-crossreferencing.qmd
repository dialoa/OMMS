...
Do not cross-refer to specific pages. Avoid:

``` markdown
... as we explained on [page 5](#explanation).
```

Page numbers don't make sense in HTML output. Manual references to 
them need to be updated if your PDF's page numbers change, which is 
time-consuming and error-prone. 

Either ask the author to name the target (e.g. paragraph section, 
statement, ...) or use a reference in terms of section (`in the 
middle of section 2').
