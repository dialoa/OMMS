...
### Display formulas and punctuation

Should we use period and commas after display equations, 
as if there were normal parts of a sentence? 

::: markdown

... as in the famous equation:
$$
E = mc^2
$$.
...
**Dialectica guidelines**. Our preference is to treat them as part
of a sentence. That seems to be the dominant convention in maths.
But we don't actively modify manuscripts to impose it. 
